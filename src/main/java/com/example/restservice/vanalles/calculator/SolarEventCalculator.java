//package com.example.restservice.vanalles.calculator;
//
...
//    final private cityLocationDate cityLocationDate;
//    final private TimeZone timeZone;
//
//
//    public SolarEventCalculator(cityLocationDate cityLocationDate, String timeZoneIdentifier) {
//        this.cityLocationDate = cityLocationDate;
//        this.timeZone = TimeZone.getTimeZone(timeZoneIdentifier);
//    }
//
//    public SolarEventCalculator(cityLocationDate cityLocationDate, TimeZone timeZone) {
//        this.cityLocationDate = cityLocationDate;
//        this.timeZone = timeZone;
//    }
//
//    public static void getOfficialSunsetCalendarForDate(Calendar instance) {
//    }
//
//    /**
...
//        return divideBy(cityLocationDate.getLongitude(), BigDecimal.valueOf(15));
//    }
//
//    /**
...
//        BigDecimal sinLatitude = BigDecimal.valueOf(Math.sin(convertDegreesToRadians(cityLocationDate.getLatitude()).doubleValue()));
//        BigDecimal cosLatitude = BigDecimal.valueOf(Math.cos(convertDegreesToRadians(cityLocationDate.getLatitude()).doubleValue()));
//
